get_chelsa_variables <- function(extent, EPSG){
  #' Download and crop tif files from chelsa-climate.org
  #' Cropping using country name or shapefile or extent.
  #'
  ...
  dir.create(here("data_raw","chelsa_v2_1"), showWarnings = FALSE) ## folder for climatic data
  dir.create(here("data_raw","chelsa_v2_1","temp"), showWarnings = FALSE) ## Temporary folder
