...
#'
#' @description Variable is solar radiation.
#'
...
get_srad <- function(extent_latlon, extent_proj, EPSG,
  ...
  # Write to disk
  ofile <- file.path(destination, "data_raw", "srad.tif")
  ...
  return(file.path(destination, "data_raw", "srad.tif"))
