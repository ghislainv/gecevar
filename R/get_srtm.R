#' Create multilayer Tiff file with 4 environmental variables
#'
#' @description Variables are elevation, slope, aspect and roughness.
#'
...
get_srtm <- function(extent_latlon, extent_proj, EPSG,
  ...
  # Write to disk
  ofile <- file.path(destination, "data_raw", "srtm_variables.tif")
  ...
  return(file.path(destination, "data_raw", "srtm_variables.tif"))
