...
The `gecevar` R package is Open Source and released under
...
There are many ways to contribute, such as writing tutorials, examples or tests, improving documentation, submitting bug reports and feature requests, or writing code to provide new functionalities which can be incorporated into future versions of the package. Every contributor must agree to follow the project's [Code Of Conduct](https://ecology.ghislainv.fr/gecevar/articles/Code_of_conduct.html).

# Report an issue

If you want to report a bug, request a feature, or discuss an issue,
please open an [issue](https://github.com/ghislainv/gecevar/issues) on the GitHub
project page.
...
3. Keep your fork's master and development branches up to date with changes in the ``gecevar`` repository
