...
This chunk code take around 204 seconds to run. 
...
This function takes time because total size to download from [chelsa-climat.org](https://chelsa-climate.org/) is around 4.8Gb.
