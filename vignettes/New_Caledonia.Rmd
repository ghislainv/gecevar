...
climat_path <- get_chelsa_current(extent = extent,
                                      ...
                                      resolution = 1000,
                                      rm_download = FALSE)
r_clim <- rast(climat_path)
names(r_clim)
plot(r_clim$cwd_thornthwaithe)
```
...
Extracted from [chelsa-climat.org](https://chelsa-climate.org/) the climate data from the five available models, namely, GFDL-ESM4, IPSL-CM6A-LR, MPI-ESM1-2-HR, MRI-ESM2-0 and UKESM1-0-LL.
